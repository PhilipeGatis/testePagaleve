...
export type UserListPaginationQuery = {
    readonly response: UserListPaginationQueryResponse;
    readonly variables: UserListPaginationQueryVariables;
};
...
fragment UserListFragment_1jWD3d on Query {
  search(after: $cursor, first: $count, type: USER, query: $query) {
    edges {
      node {
        __typename
        ...UserCardFragment
...
return {
  ...
  "params": {
    "cacheID": "3b358e2e0b42a8dff1ca5291017db41a",
    "id": null,
    "metadata": {},
    "name": "UserListPaginationQuery",
    "operationKind": "query",
